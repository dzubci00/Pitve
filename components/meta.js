...
export default function Meta() {
  return (
    <Head>
      <link rel="apple-touch-icon" sizes="180x180" href="/favicon2.svg" />
      <link rel="icon" type="image/png" sizes="32x32" href="/favicon2.svg" />
      <link rel="icon" type="image/png" sizes="16x16" href="/favicon2.svg" />
